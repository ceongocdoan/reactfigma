...
const TestimonialCard = ({ content, author, imageSrc }) => {
  return (
    <article className="flex flex-col self-stretch my-auto text-base leading-6 text-gray-900 bg-white rounded-3xl border border-gray-300 border-solid shadow-lg min-w-[240px] w-[89%]">
      {imageSrc && (
