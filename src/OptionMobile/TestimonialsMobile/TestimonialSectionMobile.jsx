...
const TestimonialSection = () => {
  return (
    <section className="flex flex-col justify-center self-center pb-3.5 mt-8 w-full max-w-[644px]">
      <div className="flex flex-wrap justify-center gap-4 items-center mr-0">
        {testimonials.map((testimonial, index) => (
          <TestimonialCard key={index} {...testimonial} />
        ))}
      </div>
      <nav className="flex gap-6 justify-center mt-4 mx-auto">
        <button className="flex justify-center items-center p-3 w-12 h-12 border-2 border-gray-100 border-solid shadow rounded-[100px]" aria-label="Previous testimonial">
        ...
        <button className="flex justify-center items-center p-3 w-12 h-12 border-2 border-gray-100 border-solid shadow rounded-[100px]" aria-label="Next testimonial">
