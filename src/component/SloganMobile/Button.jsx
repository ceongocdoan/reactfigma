...
function Button() {
  return (
    ...
    <button className="hover:bg-gray-200 active:scale-95 flex overflow-hidden gap-1.5 justify-center items-center px-5 py-3 mt-8 text-base font-semibold leading-6 bg-white rounded-lg border border-gray-300 border-solid shadow-sm text-slate-700">
