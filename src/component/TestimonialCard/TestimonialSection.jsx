    ...
    <section className="flex flex-col items-end w-full px-0 max-md:pl-0">
      <div className="flex overflow-hidden flex-col py-24 w-full bg-sky-600  max-md:max-w-full">
        ...
        <div className="flex flex-col mt-10 w-full max-md:max-w-full">
          <div className="flex flex-col justify-center px-16 py-16 w-full max-md:px-5 max-md:max-w-full">
            <TestimonialCarousel />
          </div>
          <div className="flex gap-10 items-center self-center max-w-full min-h-[48px] w-[1280px]">
