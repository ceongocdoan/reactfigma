    ...
    <section className="flex relative flex-col pt-20 w-full aspect-[0.280] max-h-[800px]">
      ...
      <div data-layername="container" className="flex relative items-start px-4 h-[268px]">
        <div data-layername="content" className="flex flex-col flex-1 shrink w-full basis-0 min-w-[240px]">
          <div data-layername="headingAndSupportingText" className="flex item-center flex-col w-full">
            <h1 data-layername="headingAndBadge" className=" flex item-center text-center w-full text-4xl font-semibold tracking-tighter leading-10 text-sky-700">
              ONSCHOOL -
              MỞ KHÓA KỸ NĂNG -
              NÂNG TẦM SỰ NGHIỆP
            </h1>
            {/* <h2 data-layername="headingAndBadge" className=" flex item-center text-center w-full text-4xl font-semibold tracking-tighter leading-10 text-sky-700">
              MỞ KHÓA KỸ NĂNG 
            </h2>
            <h3 data-layername="headingAndBadge" className=" flex item-center text-center w-full text-4xl font-semibold tracking-tighter leading-10 text-sky-700">
            NÂNG TẦM SỰ NGHIỆP
            </h3> */}
          ...
          <div data-layername="actions" className="flex flex-col mt-8 w-full text-base font-semibold leading-6 text-white">
            <button data-layername="buttonsButton" className="transition transform hover:bg-blue-400 active:scale-95 flex overflow-hidden gap-1.5 justify-center items-center px-5 py-3 w-full bg-sky-600 rounded-lg border-2 border-solid shadow-sm border-white border-opacity-10">
